...
const replacementImage = "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Image_not_available.png/640px-Image_not_available.png";

const Post = ({index, post}) => {
    return (
        <div className="bg-white rounded shadow-lg overflow-hidden" key={index}>
            <img src={post.image !== null ? post.image : replacementImage } alt={post.title} className="w-full h-60 object-cover" />
            <div className="p-4">
